...
import Knowyourcustomerkycverification2Controller, {
  Props,
  configJSON,
} from "./Knowyourcustomerkycverification2Controller";

export default class Knowyourcustomerkycverification2 extends Knowyourcustomerkycverification2Controller {
